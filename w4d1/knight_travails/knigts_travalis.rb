...
# Phase 0: Description
# In this project we will create a class that will find the shortest path for a Chess Knight from a starting position to an end position.
...
# Initialize your KnightPathFinder with a starting position.
# For instance:
...
# The values in the tree will be positions.
...
# Call this method in initialize; You will traverse the move tree whenever #find_path is called.
# Don't write this yet though.

# Phase I: #new_move_positions
# Before we start #build_move_tree, you'll want to be able to find new positions you can move to from a given position.
...
# For instance, we don't want to infinitely explore moving betweeen the same two positions.
# Add an instance variable, @considered_positions to keep track of the positions you have considered; 
...
# Take inspiration from your BFS algorithm: use a queue to process nodes in FIFO order.
# Start with a root node representing the start_pos and explore moves from one position at a time.
